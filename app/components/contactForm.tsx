...
export const ContactForm = () => {
  ...
  return (
    <form className='flex flex-col gap-3 w-full' onSubmit={handleSubmit} onChange={handleChange} >
      ...
      <input className='w-60 bg-indigo-600 rounded text-white font-semibold px-4 py-[5px] mx-auto mt-auto' disabled={isLoading} type='submit' value={isLoading ? 'Sending...' : 'Send Email'} />
    </form>
  )
}